function output=respSIVEw2(params,t)
%
% SIVE subroutine using Mukamel equations
% 
% ----------------------------------------------------------
% This routine performs a homogeneously broadened SIVE 1d-integral using
% time-domain equations.  They use equations 5.13 and 6.16b in first edition of his book.
% This routine is meant to be used for a sample's SIVE feature in w2 axis.
%
% Units:
% time=picoseconds
...
%				(only Gbg is used in this subroutine)
%
...
pdb=E2.*E3.*pgb1;
pdbtrans=fftshift(pdb)*(i*del/hbar); % see NOTE
output=pdbtrans;
