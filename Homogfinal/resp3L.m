function output=resp3L(params,Eflags,t,begw,endw)
%
% DOVE-Raman path subroutine using Mukamel equations
% 
% ----------------------------------------------------------
% This routine performs a homogeneously broadened DOVE-Raman 2d-integral using
...
%				(only Gcg, and Gag are used in this subroutine)
%
...
clear('E3');
clear('pag1');
pdgtrans=fftshift(pdg)*(i*Tfin/hbar)*(i*Tfin/hbar); % see NOTE
output=pdgtrans;
