...
typeofFWMst=findobj('Tag','typeofFWM');
typeofFWM=get(typeofFWMst,'Value');

errorflag=Mfactorcalc(Params,Subparams,w1beg,w1end,w2beg,w2end,wspacing,Afwphase,Abwphase,typeofFWM,Fileparams);
