function output=CARSd(Params,Eflag,t1t2vec,t)
%
% CARS subroutine using Mukamel equations
% ----------------------------------------------------------
% This routine performs a full CARS 1d-integral using
...
lambdaa=Params.solute.biglambdas.lag*3E10*2*pi; 
...
E1E2E3=E1.*E2.*E3;
GdCARS=1.*exp(-Gag.*t1).*(exp(-0.5.*(2.*1/kappaa^2.*(exp(-lambdaa.*(t1))+lambdaa.*(t1)-1))));
ht1=E1E2E3.*GdCARS;
pag1=ifft(ht1); 
