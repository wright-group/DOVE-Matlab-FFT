function output=CARSrefd(Params,Eflag,t1t2vec,t)
%
% CARS subroutine using Mukamel equations
% ----------------------------------------------------------
% This routine performs a CARS 1d-integral using
% time-domain equations.  This is for the reference CARS feature.  
%  Here, we assume no inhomogeneous broadening of the reference
% feature (it would not be a good reference if multiple parameters
% were needed to describe it).
%
